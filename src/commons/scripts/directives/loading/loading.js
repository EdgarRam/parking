...
(() => {
    ...
    const loading = () => {
        ...
        const link = ( $scope, element ) => {
            $scope.ldColor = $scope.ldColor ?  $scope.ldColor : "213e7f"
            $scope.ldSize = $scope.ldSize ? $scope.ldSize : "100"


            TweenMax.set('.circlePath', {
                attr: {
                    r: $(element).find(".mainCircle" ).attr('r')
                }
            })
            ...
            mainCircleRadius = Number(mainCircle.attr('r')),
            ...
            var circleBezier = MorphSVGPlugin.pathDataToBezier(circlePath.attr('d'), {
                offsetX: -20,
                offsetY: -5
            })
            ...
            function makeDots() {
                ...
                for (var i = 0; i < numDots; i++) {
                    ...
                    d = document.querySelector( '.puff').cloneNode(true);
        ...
        return {
            restrict: 'EA',
            replace: true,
            templateUrl: '/commons/scripts/directives/loading/loading.html',
            scope:{
                ldSize: '@',
                ldColor: '@'
            },
    ...
    angular.module( 'webappParkingCommons' )
